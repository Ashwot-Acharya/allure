...
<aside class="profile-card">
  <header>
    ...
    <a target="_blank" href="#">
      <img style="Width:120px" src="{{asset('profile/' . $post[0]-> profilepic )}}" class="hoverZoomLink">
    </a>
  ...
  <div class="profile-bio">
    ...
    {!! QrCode::size(130)->generate("Hi There I am ". $post[0]->name . " You can Mail me at: " .$post[0]->email ) !!}
</div>
